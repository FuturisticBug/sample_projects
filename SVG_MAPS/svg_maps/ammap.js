        ...
        afterWrite: function(a) {
            if (a = "object" != typeof a ? document.getElementById(a) : a) {
                ...
                if (e) {
                    ...
                    if (e.enabled) switch (g.left = null,
...
(function() {
    ...
    d.AmLegend = d.Class({
        ...
        drawLegend: function() {
            ...
            this.titleWidth = 0;
            if (g = this.title) g = d.text(this.container, g, this.color, a.fontFamily,
        ...
        createEntry: function(a) {
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) h = l.set(), a.hidden || (e = a.lineColorR, f = a.bulletBorderColorR), n = d.line(l, [0, 2 * m], [m / 2, m / 2], e, a.lineAlpha, a.lineThickness, a.dashLength), d.setCN(b,
    ...
    d.AmMap = d.Class({
        ...
        rescaleMapAndObjects: function() {
            ...
            if (this.areasSettings.adjustOutlineThickness) {
                for (var b = this.svgAreas, d = 0; d < b.length; d++)(c = b[d]) && c.setAttr("stroke-width",
            ...
            for (var c = 0; c < b.length; c++) {
                ...
                if (d) {
                    for (var d = d.split("L"), g = [], f = 0; f < d.length; f++)
                        if (d[f]) {
                            var h = d[f].split(" "),
                                h = this.xyToCoordinates(Number(h[1]), Number(h[2]), this.dpProjectionFunction, this.sourceMapWidth,
